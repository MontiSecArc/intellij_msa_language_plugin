...
public class MSAComponentInstanceNameImpl extends MSACompositeElementImpl implements MSAComponentInstanceName {

  public MSAComponentInstanceNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MSAVisitor visitor) {
    visitor.visitComponentInstanceName(this);
  }
