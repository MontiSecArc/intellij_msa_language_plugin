...
public class MSAConnectSourceImpl extends MSACompositeElementImpl implements MSAConnectSource {

  public MSAConnectSourceImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MSAVisitor visitor) {
    visitor.visitConnectSource(this);
  }
