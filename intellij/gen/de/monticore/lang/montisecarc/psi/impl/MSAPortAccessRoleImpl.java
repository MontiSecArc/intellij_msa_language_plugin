...
public class MSAPortAccessRoleImpl extends MSACompositeElementImpl implements MSAPortAccessRole {

  public MSAPortAccessRoleImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MSAVisitor visitor) {
    visitor.visitPortAccessRole(this);
  }
