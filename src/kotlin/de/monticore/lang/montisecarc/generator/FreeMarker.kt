...
class FreeMarker() {
    ...
    init {
        ...
        with(cfg) {
            ...
            ///Development/RWTH/Masterarbeit/MSA_Analyzer/intellij_msa/resources
            setDirectoryForTemplateLoading(File("/Development/RWTH/Masterarbeit/MSA_Analyzer/intellij_msa/build/resources/main"))
