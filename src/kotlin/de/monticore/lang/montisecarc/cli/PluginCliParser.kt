...
import de.monticore.lang.montisecarc.cli.plugins.*
import de.monticore.lang.montisecarc.psi.cli.CommonCompilerArguments
    ...
    private fun processPluginOptions(
        ...
        for (processor in commandLineProcessors) {
            ...
            for (optionValue in optionValuesByPlugin[processor.pluginId].orEmpty()) {
                val option = declaredOptions[optionValue!!.optionName] ?: throw CliOptionProcessingException("Unsupported plugin option: $optionValue")
