 ...
 */
class NewClearanceClass : CreateFileFromTemplateAction("Create New Information Flow Clearance Class", "Create New Information Flow Clearance Class", MSAIcons.FILE), DumbAware {

    val APPLICATION_TEMPLATE = "NewSecurityClass"

    private val NEW_MSA_FILE = "NewSecurityClass"
    ...
    override fun buildDialog(project: Project, directory: PsiDirectory, @NotNull builder: CreateFileFromTemplateDialog.Builder) {
        builder.setTitle(NEW_MSA_FILE).addKind("Information Flow Clearance Class", MSAIcons.FILE, APPLICATION_TEMPLATE)
    }
