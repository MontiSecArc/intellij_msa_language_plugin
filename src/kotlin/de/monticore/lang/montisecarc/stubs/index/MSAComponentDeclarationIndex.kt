...
class MSAComponentDeclarationIndex : StringStubIndexExtension<MSAComponentDeclaration>() {
    ...
    override fun get(key: String, project: Project, scope: GlobalSearchScope): MutableCollection<MSAComponentDeclaration> = StubIndex.getElements(MSAComponentDeclarationIndex.KEY, key, project, scope, MSAComponentDeclaration::class.java)

    private object Holder {
        val INSTANCE = MSAComponentDeclarationIndex()
    }
    ...
    companion object {
        ...
        val instance: MSAComponentDeclarationIndex by lazy { Holder.INSTANCE }
    }
}