...
public class MSAPortDeclarationImpl extends MSACompositeElementImpl implements MSAPortDeclaration {

  public MSAPortDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MSAVisitor visitor) {
    visitor.visitPortDeclaration(this);
  }
  ...
  @Override
  @NotNull
  public List<MSAPortElement> getPortElementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MSAPortElement.class);
  }
