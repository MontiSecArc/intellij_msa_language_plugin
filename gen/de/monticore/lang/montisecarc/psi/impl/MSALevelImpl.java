...
public class MSALevelImpl extends MSACompositeElementImpl implements MSALevel {

  public MSALevelImpl(ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getNumber() {
    return notNullChild(findChildByType(NUMBER));
  }
