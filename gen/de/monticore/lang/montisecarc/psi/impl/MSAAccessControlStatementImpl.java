...
public class MSAAccessControlStatementImpl extends MSACompositeElementImpl implements MSAAccessControlStatement {

  public MSAAccessControlStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MSAVisitor visitor) {
    visitor.visitAccessControlStatement(this);
  }
